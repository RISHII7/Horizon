                            ...
                            {type === 'sign-up' && (
                                <>
                                    <div className="flex gap-4">
                                        <CustomInput control={form.control} name="firstName" label="First Name" placeholder="ex: Jon" />
                                    ...
                                    <div className="flex gap-4">
                                        ...
                                        <CustomInput control={form.control} name="postalCode" label="Postal Code" placeholder="ex: 411032" />
                                    </div>
